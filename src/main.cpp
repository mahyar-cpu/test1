...
uint256 hashGenesisBlock("0x2102a8c7e252060a009df68e36c19279a49a366485d3f07400eaf2d45836a93c");
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // Funcoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // Funcoin: 3.5 days
static const int64 nTargetSpacing = 1 * 60; // Funcoin: 2.5 minutes
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x398507921a2cdba200e44829fc26fac65dc9d5903d7f32b567359c19328f7526");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].nValue = 12 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04f6a74e4f53a11f6da13718bfa8a46f6e61692817ed4879178a516e3eba16dac995f7e157d6a6d3c419155e95af6720aba3920804529b96a523b6d78646dbc7a3") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1577886884;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2085724250;

        if (fTestNet)
        {
            block.nTime    = 1577886861;
            block.nNonce   = 386579352;
        }
...
if (false && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("0xf676c297be1625890b2753be768fbdd5b0ff1034ba0b21eb341f0eaa90a46c01"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xf1, 0xc2, 0xb3, 0xd4 }; // Funcoin: increase each by adding 2 to bitcoin's value.
